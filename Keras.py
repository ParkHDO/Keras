...
class PoseClassifierApp(QWidget):
    ...
    def load_model(self):
        # 분류 모델을 로드합니다.
        self.model = load_model("C:/2024_HD/TM001/model/keras_Model.h5", compile=False)
        self.class_names = open("C:/2024_HD/TM001/model/labels.txt", "r", encoding="utf-8").readlines()
